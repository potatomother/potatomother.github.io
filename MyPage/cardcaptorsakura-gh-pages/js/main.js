...
function create_CCS_chart() {
    ...
    d3.queue()
        .defer(d3.json, "/MyPage/cardcaptorsakura-gh-pages/data/ccs_chapter_hierarchy.json")
        .defer(d3.json, "/MyPage/cardcaptorsakura-gh-pages/data/ccs_chapter_total.json")
        .defer(d3.json, "/MyPage/cardcaptorsakura-gh-pages/data/ccs_character_per_chapter.json")
        .defer(d3.json, "/MyPage/cardcaptorsakura-gh-pages/data/ccs_character_per_chapter_cover.json")
        .defer(d3.csv, "/MyPage/cardcaptorsakura-gh-pages/data/ccs_character_total.csv")
        .defer(d3.csv, "/MyPage/cardcaptorsakura-gh-pages/data/ccs_character_relations.csv")
        .defer(d3.json, "/MyPage/cardcaptorsakura-gh-pages/data/ccs_color_distribution.json")
        .await(draw);
    ...
    function draw(error, chapter_hierarchy_data, chapter_total_data, character_data, cover_data, character_total_data, relation_data, color_data) {
        ...
        var cover_image = image_group.append("pattern")
            ...
            .attr("width", "100%")
            .append("image")
            .attr("xlink:href", "/MyPage/cardcaptorsakura-gh-pages/img/white-square.jpg")
        ...
        function mouse_over_character(d) {
            ...
            cover_image.attr("xlink:href", "/MyPage/cardcaptorsakura-gh-pages/img/character-" + d.character.toLowerCase() + ".jpg")
        ...
        function mouse_over_chapter(d,i) {
            ...
            cover_image.attr("xlink:href", "/MyPage/cardcaptorsakura-gh-pages/img/ccs-chapter-" + (i+1) + ".jpg")
            cover_circle.style("fill", "url(#cover-image)");
        ...
        function mouse_out() {
            ...
            cover_image.attr("xlink:href", "/MyPage/cardcaptorsakura-gh-pages/img/white-square.jpg");
